...
def register(cat, page, F):
    ...
    Q = [
     ...
     ("has-kronos-built-a-reactor","Has Kronos built a reactor?",
      "Not yet — but construction of the HYPERION breeder is scheduled to begin in Q2 2027; today Kronos is a design-and-simulation study.",
      ["Not yet — and this is the pivotal year: construction of the HYPERION breeder is scheduled to begin in Q2 2027. Today Kronos is at the physics-design and simulation stage, and every figure it publishes is a computed design target, reproducible from open deposits; the interactive model is a design instrument, not yet a mirror of operating hardware.",
